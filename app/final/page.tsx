...
<select className="select select-primary" name="type" id="type">
...
<select className="select select-primary" name="concern" id="concern">
...
<br/>
  <input type="radio" id="1 oz" className="radio radio-primary" name="size" value="1 oz" />
  <label htmlFor="1 oz"> 1 oz</label><br />
  <input type="radio" id="4 oz" className="radio radio-primary" name="size" value="4 oz" />
  <label htmlFor="4 oz"> 4 oz</label><br />
  <input type="radio" id="8 oz" className="radio radio-primary" name="size" value="8 oz" />
  <label htmlFor="8 oz"> 8 oz</label>
  </div>
  <br />

  <label htmlFor="skin concern" className="mx-5 text-xl text-pink-200">Choose Product Rating:</label>
<select className="select select-primary" name="rating" id="rating">
...
<h3 className="ml-5 mt-5 text-xl text-pink-200">Key Ingredients:</h3>
  ...
  <input type="checkbox" id="Ingredients" className="checkbox checkbox-primary" name="Ingredients" value="Niacinamide" />
  <label htmlFor="niacinamide"> Niacinamide</label><br />
  <input type="checkbox" id="Ingredients" className="checkbox checkbox-primary" name="Ingredients" value="Panthenol" />
  <label htmlFor="panthenol"> Panthenol</label><br />
  <input type="checkbox" id="Ingredients" className="checkbox checkbox-primary" name="Ingredients" value="Hyaluronic Acid" />
  <label htmlFor="hyaluronic"> Hyaluronic Acid</label><br />
  <input type="checkbox" id="Ingredients" className="checkbox checkbox-primary" name="Ingredients" value="Retinol" />
  <label htmlFor="retinol"> Retinol</label><br />
  <input type="checkbox" id="Ingredients" className="checkbox checkbox-primary" name="Ingredients" value="Vitamin C" />
  <label htmlFor="vitamin"> Vitamin C</label><br />
  <input type="checkbox" id="Ingredients" className="checkbox checkbox-primary" name="Ingredients" value="Ceramides" />
